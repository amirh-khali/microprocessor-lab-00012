...
; 0000 0039     led = 0;
	CLR  R4
; 0000 003A     PORTC = PORTC & 0b11110111;
	CBI  0x15,3
; 0000 003B }
; 0000 003C else
	RJMP _0x8
...
; 0000 003E     led = 1;
	LDI  R30,LOW(1)
	MOV  R4,R30
; 0000 003F     PORTC = PORTC | 0b00001000;
	SBI  0x15,3
; 0000 0040 }
_0x8:
; 0000 0041 }
...
; 0000 0049 PORTB=(0<<PORTB7) | (0<<PORTB6) | (0<<PORTB5) | (0<<PORTB4) | (0<<PORTB3) | (0<<PORTB2) | (0<<PORTB1) | (0<<PORTB0);
	OUT  0x18,R30
; 0000 004A DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (1<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	LDI  R30,LOW(8)
	OUT  0x14,R30
...
; 0000 0052 // INT1: On
; 0000 0053 // INT1 Mode: Falling Edge
; 0000 0054 // INT2: On
; 0000 0055 // INT2 Mode: Falling Edge
; 0000 0056 GICR|=(1<<INT1) | (1<<INT0) | (1<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xE0)
	OUT  0x3B,R30
; 0000 0057 MCUCR=(1<<ISC11) | (0<<ISC10) | (1<<ISC01) | (0<<ISC00);
	LDI  R30,LOW(10)
	OUT  0x35,R30
; 0000 0058 MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 0059 GIFR=(1<<INTF1) | (1<<INTF0) | (1<<INTF2);
	LDI  R30,LOW(224)
	OUT  0x3A,R30
; 0000 005A 
...
; 0000 0063 
; 0000 0064 
; 0000 0065 // Alphanumeric LCD initialization
; 0000 0066 // Connections are specified in the
; 0000 0067 // Project|Configure|C Compiler|Libraries|Alphanumeric LCD menu:
; 0000 0068 // RS - PORTC Bit 0
; 0000 0069 // RD - PORTC Bit 1
; 0000 006A // EN - PORTC Bit 2
; 0000 006B // D4 - PORTC Bit 4
; 0000 006C // D5 - PORTC Bit 5
; 0000 006D // D6 - PORTC Bit 6
; 0000 006E // D7 - PORTC Bit 7
; 0000 006F // Characters/line: 16
; 0000 0070 lcd_init(16);
	LDI  R26,LOW(16)
	CALL _lcd_init
; 0000 0071 
; 0000 0072 // Global enable interrupts
; 0000 0073 #asm("sei")
	sei
; 0000 0074 
; 0000 0075 
